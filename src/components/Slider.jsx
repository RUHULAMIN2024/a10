    ...
    <>
      ...
      >
        <SwiperSlide className='relative'>
          ...
          <div className='absolute top-40 text-center  left-1/2 -translate-x-1/2  text-white'>
            <h2 className='text-4xl font-bold mb-5'>Discover the Serenity of Pristine Beaches</h2>
            <p>Welcome to a world of boundless exploration and enchantment! Step into a realm where pristine beaches stretch as far as the eye can see, inviting you to bask in the warmth of the sun</p>
          </div>
        </SwiperSlide >

...
const Home = () => {
    ...
    return (
        <div className="container mx-auto">
            ...
            <h2 className="text-center mt-16 text-2xl md:text-4xl font-bold">Countries </h2>
            <div className="grid grid-cols-1 my-12 md:grid-cols-2 lg:grid-cols-3 gap-8">

                {
                    country.map(item => (
                        <Link to={`/countryBaseSpot/${item.country}`} key={item._id} className="card transition-all hover:scale-105 bg-base-100 shadow-xl">
